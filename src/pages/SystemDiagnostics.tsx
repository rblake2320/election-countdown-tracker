...
import { ComprehensiveDiagnostics } from '@/components/ComprehensiveDiagnostics';
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="text-center mb-8">
            ...
            <p className="text-white/80 text-lg max-w-2xl mx-auto">
              Comprehensive testing to identify exactly what is working and what needs to be fixed
            </p>
          </div>
